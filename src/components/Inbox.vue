...
<template>
	<div id="inbox">
		...
		<Decision ref="decision" v-for="decision in decisions" :ign=decision.ign :question=decision.question :options=decision.options :decKey=decision.key :key=decision.key />
	</div>
</template>
